...
from backend.apps.cron.cron import cron
...
main_app = MainApp([health, agents, skills, tools_lib, modes, settings, mcp_registry, skill_registry, outputs, dashboards, cron, service, subscription, auth, web, anthropic_proxy])
app = main_app.app
