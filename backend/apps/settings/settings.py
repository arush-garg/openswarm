...
# Directory for uploaded files (used by upload GC and tests)
...
def _normalize_dreaming_settings(settings_obj: AppSettings) -> None:
    ...
    Keeps the UX graceful: if OpenClaw is missing, preserve the user's
    intent but publish a clear status message instead of throwing validation errors.
    """
